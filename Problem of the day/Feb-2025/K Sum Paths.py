class Solution:
    def sumK(self, root, k):
        ...
        def dfs(node, current_sum, prefix_sum):
            ...
            count = prefix_sum[current_sum - k]  # Check if (current_sum - k) exists
            
            # Update prefix_sum with the current sum
            ...
            # Backtrack: Remove the current sum from hashmap
            prefix_sum[current_sum] -= 1
        ...
        prefix_sum[0] = 1  # Base case for when a path itself equals k
